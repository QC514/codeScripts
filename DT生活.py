...
if len(CODE_URL_LIST) == 0:
    print("❌ 错误：未读取到环境变量 qingyun_openid 或无有效地址！")
...
def get_user_info(token, headers, proxy_config, account_name):
    ...
    try:
        ...
        req_headers = {**headers, "X-Api-Key": VMPF_API_KEY}
...
if __name__ == "__main__":
    print("===== DT生活签到（环境变量qingyun_openid读取内网多服务+独立代理版）=====\n")
